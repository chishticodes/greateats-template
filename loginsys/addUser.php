...
<main>
  <div class="container d-flex flex-column align-items-center">
    ...
    <form action="" class="mt-4 w-75 resize-form">
      ...
      <div class="mb-3">
        <label for="passwordRepeat" class="form-label">Re-Enter Password</label>
        <input type="password" class="form-control" id="passwordRepeat" name="passwordRepeat" placeholder="Re-Enter your Password">
      </div>
      <div class="mb-3">
